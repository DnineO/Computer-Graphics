...
class gui_tk(tkinter.Tk):
    ...
    def onCreateAGClick(self):
        ...
        if isStrInt(noNodes):
            ...
            if (noNodes < 4):
                tkinter.showwarning("Warning", "Entry for nodes is less than 4.")
                return
        else:
            tkinter.showwarning("Warning", "Entry for nodes is not an integer.")
            return
        ...
        if isStrInt(noEdges):
            ...
            if (noEdges < 3):
                tkinter.showwarning("Warning", "Entry for edges is less than 3.")
                return
            if (noEdges < (noNodes - 1)):
                tkinter.showwarning("Warning", "Entry for edges must be enough for a tree structure. Needs %d." % (
                            noNodes - 1))
                return
            if (noEdges > (noNodes * (noNodes - 1)) / 2):
                tkinter.showwarning("Warning", "Entry for edges provided is more than a complete graph.")
                return
        else:
            tkinter.showwarning("Warning", "Entry for edges is not an integer.")
            return
    ...
    def onViewAGClick(self):
        ...
        if self.G:
            ...
            tkinter.showwarning("Warning", "Create Arbitrary Graph first to view Arbitrary Graph.")
            return
    ...
    def onCreateCGClick(self):
        ...
        if self.G:
            ...
            tkinter.showwarning("Warning", "Create Arbitrary Graph first before create Chordal Graph.")
            return
    ...
    def onViewCGClick(self):
        ...
        if self.H:
            ...
            tkinter.showwarning("Warning", "Create Chordal Graph first to view Chordal Graph.")
            return
