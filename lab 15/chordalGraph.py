...
class ChordalGraph:
    ...
    def createAG(self):
        ...
        self.G = {0: [15], 1: [8, 2, 3, 10], 2: [1, 10, 5, 6], 3: [1, 15], 4: [5], 5: [2, 4, 6, 15], 6: [9, 2, 12, 5],
                  7: [8, 11, 13], 8: [1, 14, 7], 9: [10, 6, 15], 10: [1, 2, 12, 13, 9], 11: [7], 12: [10, 13, 6],
                  13: [10, 15, 12, 7], 14: [8, 15], 15: [0, 3, 5, 9, 13, 14]}
